...
-- Step 2: foreign keys and indexes on the new tables.
DO $$ BEGIN
...
-- Step 3: backfill from review_run. Guarded by NOT EXISTS so this is safe to
-- re-run (e.g. after a partial apply).
...
-- parent ids equal the old review_run ids).
