...
This is non-blocking. The recommendation above does not depend on the answer—it holds either way, since today's code extracts no such claim regardless of whether one exists in the token.
